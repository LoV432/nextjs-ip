	...
	return (
		<>
			<div className="flex flex-col items-center gap-20">
				...
				<svg onClick={scrollToBottom} className={`${style.scrollDownAnimation} h-8 w-8 rounded-full fill-rose-900 hover:cursor-pointer`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
